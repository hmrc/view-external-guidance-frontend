...
package object ocelot {
  ...
  val JavascriptLinkPattern: String = "javascript\\:.+?"
  val EmailLinkPatern: String = "mailto\\:.+?"
  ...
  val linkPattern: String = s"\\[(button|link)(-same|-tab)?:(.+?):($StanzaIdPattern|$HttpUriPattern|$JavascriptLinkPattern|$EmailLinkPatern)\\]"
